...
//Shreen share - to be added
  ...
  //     });
  //     replaceVideoPlayer(screenStream);
  //     for (const room_id in roomplayers) {
  //       if (room_id == roomid) {
  //         for (const id in roomplayers[room_id]) {
  //           peer.connect(roomplayers[room_id][id]);
  ...
  //               var call = peer.call(roomplayers[room_id][id], screenStream);
...
// function replaceVideoPlayer(screenStream) {
//   let videoPlayer = document.getElementById('video-player');
//   videoPlayer.innerHTML = "";

//   const video = document.createElement('video');
//   const videoContainer =document.getElementById('video-player')
//   if (videosAry.includes(screenStream.id)) return;
//   video.srcObject = screenStream;
//   video.id = screenStream.id;
//   videosAry.push(screenStream.id);
//   video.addEventListener('loadedmetadata', () => {
//     video.play();
//     videoContainer.append(video);
//   });
